...
console.log(`ПЕрвый символ строки ${name}: `, name[0]);
console.log(`Четвёртый символ строки ${name}: `, name[3]);
console.log(`Последний символ строки ${name}: `, name[9]);
console.log(`Последний индекс символа строки ${name}: `, name.length - 1);
