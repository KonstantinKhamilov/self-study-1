...
// Метод indexOf() для определения индекса строки
const message = `Пробуем найти индекс строки`;
console.log(`Метод indexOf(): `, message.indexOf(`найти`)); //8

// Метод includes()
const message = `Пробуем найти индекс строки`;
console.log(`Метод includes(): `, message.includes(`найти`)); // true


// Методы startsWith() & endsWith()
const message = `Пробуем найти индекс строки`;
console.log(`Метод startsWith(): `, message.startsWith(`Про`)); // true
console.log(`Метод endsWith(): `, message.endsWith(`екс`)); // fals
...
console.log(`Метод substring(0, 4): `, message.substring(0, 4)); // Java
console.log(`Метод substring(4, 0): `, message.substring(4, 0)); // Java
console.log(`Метод substring(4): `, message.substring(4)); //Script
// slice()
console.log(message); // JavaScript
console.log(`Метод slice(0, 4): `, message.slice(0, 4)); // Java
console.log(`Метод slice(4, 0), пустая строка: `, message.slice(4, 0)); // Java
console.log(`Метод slice(4): `, message.slice(4)); //Script
console.log(`Метод slice(-6): `, message.slice(-6)); //Script

// repeat() - повторение/копирование строки
const message = `JavaScript`;
console.log(message); // JavaScript
console.log(`Метод repeat(2): `, message.repeat(2)); // JavaScriptJavaScript


// Метод replace() - замна подстрок в строке
const message = `Я изучаю бэкенд, но пока мало знаю про бэкенд`;
console.log(message);
console.log(
  `Метод replace('бэкенд', 'фронтенд'): `,
...
console.log(
  `Применение регулярных выражений /``/gi, вместо replaceAll(): `,
  message.replace(/бэкенд/gi, "фронтенд")
); // Я изучаю бэкенд, но пока мало знаю про бэкенд
