...
// Метод at
const name = `Konstantin`;
console.log(`Символ строки ${name} под индексом 0: `, name.at);
console.log(`Символ строки ${name} под индексом 1: `, name.at(1));
console.log(`Последний символ строки ${name}: `, name.at(-1));
console.log(`Предпоследний символ строки ${name}: `, name.at(-2));
