...
const message = `Пробуем_найти_индекс_строки`;
console.log(`Метод startsWith(): `, message.startsWith(`Пробуем`)); // true
console.log(`Метод endsWith(): `, message.endsWith(`строку`)); // true
