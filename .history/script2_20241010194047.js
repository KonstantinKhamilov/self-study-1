...
const price = (params) => {
  ...
  console.log(`округление до первого знака после запятой: `, params.toFixed(1));
  console.log(`округление до второго знака после запятой: `, params.toFixed(2));
  console.log(
    `округление до третьего знака после запятой: `,
    params.toFixed(3)
  );
};
