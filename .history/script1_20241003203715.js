...
//Создание калькулятора с помощью методов read() sum() null()
const cdlculate = {
  read() {
    (this.a = +prompt(`Введите первое число`)), //Промпт всегда приводит к строке. + что бы привести к числу, чтоб не писать метод Number()
